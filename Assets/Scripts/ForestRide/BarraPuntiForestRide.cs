...
public class BarraPuntiForestRide : MonoBehaviour {

	public Image Barra, Stella1, Stella2, Stella3;
	public AudioSource Suono;
	public AudioClip UnoeDue, Tre, VittoriaSuono;
	public Sprite StellaON;
	public GameObject Stelline, StellaWin, Raggi, SfondoWin, Sfondo;
	...
	void Vittoria()
    {
        var clones = GameObject.FindGameObjectsWithTag("Dolcetti");
        foreach (var d in clones)
        {
            Destroy(d);
        }
